...
```mermaid
    graph LR
        ...
        builtins_object("object(builtins)") --> codes.dataset.trajectories.__picker_Annotation("Annotation(codes.dataset.trajectories.__picker)")
        ...
        codes.dataset.inputs.__baseInputManager_BaseInputManager("BaseInputManager(codes.dataset.inputs.__baseInputManager)") --> codes.dataset.inputs.__trajectoryManager_TrajectoryManager("TrajectoryManager(codes.dataset.inputs.__trajectoryManager)")
        codes.dataset.inputs.__baseInputManager_BaseInputManager("BaseInputManager(codes.dataset.inputs.__baseInputManager)") --> codes.dataset.inputs.maps.__trajMapManager_TrajMapManager("TrajMapManager(codes.dataset.inputs.maps.__trajMapManager)")
        codes.dataset.inputs.maps.__trajMapManager_TrajMapManager("TrajMapManager(codes.dataset.inputs.maps.__trajMapManager)") --> codes.dataset.inputs.maps.__socialMapManager_SocialMapManager("SocialMapManager(codes.dataset.inputs.maps.__socialMapManager)")
        codes.base.__baseManager_BaseManager("BaseManager(codes.base.__baseManager)") --> codes.dataset.inputs.__baseInputManager_BaseInputManager("BaseInputManager(codes.dataset.inputs.__baseInputManager)")
        codes.dataset.inputs.__baseInputManager_BaseInputManager("BaseInputManager(codes.dataset.inputs.__baseInputManager)") --> codes.dataset.inputs.__agentFiles_AgentFilesManager("AgentFilesManager(codes.dataset.inputs.__agentFiles)")
        ...
        codes.dataset.inputs.maps.__trajMapManager_TrajMapManager("TrajMapManager(codes.dataset.inputs.maps.__trajMapManager)") --> codes.dataset.inputs.maps.__trajMapManager_seg_TrajMapManager_seg("TrajMapManager_seg(codes.dataset.inputs.maps.__trajMapManager_seg)")
        codes.dataset.inputs.__baseInputManager_BaseInputManager("BaseInputManager(codes.dataset.inputs.__baseInputManager)") --> codes.dataset.inputs.maps.__mapParasManager_MapParasManager("MapParasManager(codes.dataset.inputs.maps.__mapParasManager)")
