...
```mermaid
    graph LR
        codes.base_BaseObject("BaseObject(codes.base)") --> codes.training.__vis_Visualization("Visualization(codes.training.__vis)")
        ...
        builtins_object("object(builtins)") --> codes.base_BaseObject("BaseObject(codes.base)")
        ...
        codes.base_BaseObject("BaseObject(codes.base)") --> codes.dataset.__videoClipManager_VideoClipManager("VideoClipManager(codes.dataset.__videoClipManager)")
        ...
        codes.base_BaseObject("BaseObject(codes.base)") --> codes.dataset.__videoDatasetManager_DatasetManager("DatasetManager(codes.dataset.__videoDatasetManager)")
        builtins_object("object(builtins)") --> codes.dataset.__videoDataset_Dataset("Dataset(codes.dataset.__videoDataset)")
        codes.base_BaseObject("BaseObject(codes.base)") --> codes.dataset.__agentManager_AgentManager("AgentManager(codes.dataset.__agentManager)")
        builtins_object("object(builtins)") --> codes.dataset.__trajectory_Trajectory("Trajectory(codes.dataset.__trajectory)")
        codes.base_BaseObject("BaseObject(codes.base)") --> codes.dataset.__picker_Picker("Picker(codes.dataset.__picker)")
        codes.base_BaseObject("BaseObject(codes.base)") --> codes.dataset.__maps_MapManager("MapManager(codes.dataset.__maps)")
