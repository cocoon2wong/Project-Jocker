...
```mermaid
    graph LR
        ...
        codes.__base_BaseObject("BaseObject(codes.__base)") --> codes.dataset.__videoDatasetManager_DatasetManager("DatasetManager(codes.dataset.__videoDatasetManager)")
        builtins_object("object(builtins)") --> codes.__base_BaseObject("BaseObject(codes.__base)")
        codes.__base_BaseObject("BaseObject(codes.__base)") --> codes.dataset.__agentManager_AgentManager("AgentManager(codes.dataset.__agentManager)")
        ...
        codes.__base_BaseObject("BaseObject(codes.__base)") --> codes.dataset.__videoClipManager_VideoClipManager("VideoClipManager(codes.dataset.__videoClipManager)")
