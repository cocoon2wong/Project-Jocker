...
@LastEditTime: 2024-01-29 15:31:52
...
class EVDModel(BaseAgentModel):
    ...
    def __init__(self, Args: AgentArgs,
        ...
        self.outer_fc = layers.Dense((self.d//4)**2, self.d, torch.nn.Tanh)
...
class EVD(BaseAgentStructure):
    """
    Training structure for the `EVD` model.
