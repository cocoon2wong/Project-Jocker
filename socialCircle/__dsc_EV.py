...
@LastEditTime: 2023-09-07 16:47:25
...
from .__layers import DynamicSocialCircleLayer
...
class EVSCModel(BaseSocialCircleModel):
    ...
    def __init__(self, Args: SocialCircleArgs, as_single_model: bool = True,
        ...
        self.sc = DynamicSocialCircleLayer(
        ...
        self.sc_fusion = tf.keras.layers.Dense(1, tf.nn.relu)
    ...
    def call(self, inputs, training=None, mask=None, *args, **kwargs):
        ...
        social_circle_fused = self.sc_fusion(social_circle)[..., 0]
        f_social = self.tse(social_circle_fused)    # (batch, steps, d/2)
