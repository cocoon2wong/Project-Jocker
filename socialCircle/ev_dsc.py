...
@LastEditTime: 2024-01-29 15:26:32
...
class EVDSCModel(BaseSocialCircleModel):
    """
    E-V^2-Net-SC
    ---
    ...
    def __init__(self, Args: AgentArgs, as_single_model: bool = True,
        ...
        # Concat and fuse SC
        self.concat_fc = layers.Dense(self.d, self.d, torch.nn.Tanh)
...
class EVDSCStructure(BaseSocialCircleStructure):
    MODEL_TYPE = EVDSCModel
